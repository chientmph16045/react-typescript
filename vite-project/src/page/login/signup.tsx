...
const Signup = () => {
    ...
    const onAdd:SubmitHandler<IUser>= async (dataUser)=>{
      ...
      try {
        const {data} =await axios.post("http://localhost:8000/api/signup",dataUser)
                                    ...
                                    <div className="p-5">
                                        ...
                                        <form className="user" onSubmit={handleSubmit(onAdd)}>
                                            <div className="form-group">
                                                ...
                                                {errors.name && errors.name.type ==="required" && (<span style={{color:"red", fontSize:"13px"}}>Trường dữ liệu bắt buộc</span>)}
                                            </div>
                                            <div className="form-group">
                                            ...
                                            <button className="btn btn-primary btn-user btn-block">sign up</button>
